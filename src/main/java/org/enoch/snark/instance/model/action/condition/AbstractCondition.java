...
public abstract class AbstractCondition {
    ...
    public abstract boolean fit(PlanetEntity colony);

    public abstract String reason(PlanetEntity colony);
    ...
    private static AbstractCondition create(String key, String value) {
        ...
        switch (conditionType) {
            ...
            case RESOURCES_COUNT_IN_SOURCE: return new ResourceCountCondition(NumberUtil.toLong(value));
