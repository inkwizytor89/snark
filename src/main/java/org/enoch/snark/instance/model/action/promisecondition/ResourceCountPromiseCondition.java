...
public class ResourceCountPromiseCondition extends AbstractPromiseCondition {
    private final Long resourcesCount;
    private final ConditionType conditionType;

    private PlanetEntity planetEntity;

    public ResourceCountPromiseCondition(Long resourcesCount, ConditionType conditionType) {
