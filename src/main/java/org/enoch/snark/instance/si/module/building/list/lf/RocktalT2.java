...
public class RocktalT2 extends AbstractBuildingList {
    ...
    public List<BuildRequest> create() {
        List<BuildRequest> buildRequests = new ArrayList<>(new RocktalT1(StringUtils.EMPTY).create());
        buildRequests.addAll(Arrays.asList(
                new BuildRequest(LFBuilding.lifeformTech12101, 41),
                new BuildRequest(LFBuilding.lifeformTech12102, 43),
                new BuildRequest(LFBuilding.lifeformTech12104, 1)
        ));
